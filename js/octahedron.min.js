...
// By: Joey Kim.
setTimeout(function(){var c=document.getElementById("test").getContext("2d");function f(a,e,d){this.x=a;this.y=e;this.z=d}f.prototype.a=function(a){return Math.sqrt((a.x-this.x)*(a.x-this.x)+(a.y-this.y)*(a.y-this.y)+(a.z-this.z)*(a.z-this.z))};var h=new f(2.7,.45,-1.85),k=new f(-.05,-1.05,0);
...
.05;a.preventDefault();break;default:console.log(a.keyCode)}});}, 100);
